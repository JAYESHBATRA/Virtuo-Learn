...
Virtuo Learn is a platform that provides immersive learning experiences like never before. It offers simulations, 3D visualizations, customized quizzes, a doubt engine, and videos, all in one place.
...
- Then set upstream using the command git remote add upstream https://github.com/JAYESHBATRA/Virtuo-Learn.git
